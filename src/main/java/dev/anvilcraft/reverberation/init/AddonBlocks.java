...
import dev.anvilcraft.reverberation.block.ClangCrystal;
...
public class AddonBlocks {
    ...
    public static final BlockEntry<ClangCrystal> CLANG_CRYSTAL = REGISTRATE
        .block("clang_crystal", ClangCrystal::new)
